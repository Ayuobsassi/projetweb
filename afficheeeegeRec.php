        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-share"></i> <span>Produits</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="ajout-produits.html"><i class="fa fa-circle-o"></i> Ajout Produits</a></li>
                        <li class="treeview">
                            <a href="modifier-produits.html"><i class="fa fa-circle-o"></i> Modification Produits</a>
                        </li>
                        <li><a href="#"><i class="fa fa-circle-o"></i> Suppression Produits</a></li>
                    </ul>
                </li>
...
//    echo" <td> Contenu_pub </td>";
               ...
               // echo '<td><a href="modifieeeer.php?id_pub='.$row['id_pub'].'">Modifier  </a></td>';
                echo "<br>";
                echo '<td><a href="../views/supprimerPublicationAdmin.php?id_pub='.$row['id_pub'].'">Supprimer  </a></td>';
                echo "<br>";
                echo '<td><a href="../views/reagirPublicationAdmin.php?t=1&id_pub='.$row['id_pub'].'">Like  </a></td>';
                echo '<td><a href="../views/reagirPublicationAdmin.php?t=2&id_pub='.$row['id_pub'].'">Dislike </a></td>';
                echo "<br>";
                echo "<br>";
