                                ...
                                <ul>
                                    ...
                                    <li class="hassubs">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="categories.html"> Camera de surveillance</a></li>
                                            <li><a href="categories.html">Ordinateurs et Accessoires</a></li>
                                            <li><a href="categories.html">Televisions et Accessoires</a></li>
                                        </ul>
                                    </li>
...
//    echo" <td> Contenu_pub </td>";
    ...
    echo "<br>";
    echo" <tr>";
    echo '<td><a href="modifieeeer.php?id_pub='.$row['id_pub'].'">Modifier  </a></td>';
    echo "<br>";
    echo '<td><a href="../views/supprimerPublication.php?id_pub='.$row['id_pub'].'">Supprimer  </a></td>';
    echo "<br>";
    echo '<td><a href="../views/reagirPublication.php?t=1&id_pub='.$row['id_pub'].'">Like  </a></td>';
    echo '<td><a href="../views/reagirPublication.php?t=2&id_pub='.$row['id_pub'].'">Dislike </a></td>';
    echo "<br>";
    echo "<br>";
                ...
                <div class="col-lg-3 offset-xl-1 contact_col">
                    <div class="contact_info">
                        <div class="contact_info_section">
                            ...
                            <ul>
                                <li>Phone: <span>+21629194048</span></li>
                                <li>Email: <span>ProSystemes@gmail.com</span></li>
                            </ul>
                        </div>
                        <div class="contact_info_section">
            ...
            <div class="row">
                <div class="col">
                    <div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
                        <div class="footer_logo"><a href="#">ProSystemes.</a></div>
